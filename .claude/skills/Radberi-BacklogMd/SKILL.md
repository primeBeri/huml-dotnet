---
name: Radberi-BacklogMd
description: Use when creating tasks, updating task status, managing acceptance criteria, or using the Backlog.md CLI for task tracking; invoke before any task file operations or when planning multi-step work that needs tracking
---
...
**FORMAT REFERENCE ONLY** - The following sections show what you'll SEE in task files.
