...
---
*Last updated: 2026-05-02 — Phase 11 complete: enum serialisation and deserialisation support added. `HumlEnumValueAttribute`, `EnumNameCache`, and targeted patches to `HumlSerializer`/`HumlDeserializer`. 821 tests green across net8.0/net9.0/net10.0.*
